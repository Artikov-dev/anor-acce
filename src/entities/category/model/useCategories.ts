...
import type { ICategory, CreateCategoryDto, UpdateCategoryDto } from './types'
...
export const useCategoryById = useCategoryQuery
export const useCreateCategory = useCreateCategoryMutation
export const useUpdateCategory = useUpdateCategoryMutation
export const useDeleteCategory = useDeleteCategoryMutation
